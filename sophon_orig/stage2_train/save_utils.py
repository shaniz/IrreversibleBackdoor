...
def save_data(save_path,
              ...
              final_finetune_restrict_test_loss, total_loop_index, fts_index, ntr_index, total_loop_idx_finetune):
    ...
    with open(save_path + '/' + 'finetune_restrict_test.csv', mode='w', newline='') as file:
        ...
        for i, j, k in zip(total_loop_idx_finetune, all_finetune_restrict_test_loss, all_finetune_restrict_test_acc):
            writer.writerow([i, j, k])
