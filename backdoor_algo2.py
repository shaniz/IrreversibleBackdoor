...
def main(
    ...
    circular_dual_dl = CircularDualDataloader(restrict_trainloader, bd_restrict_trainloader)
    ...
    for i in range(1, total_loop+1):
        ...
        for fts in range(args.fts_loop):  # fine-tuning suppression - restricted
            ...
            loss_fts, acc_fts = fast_adapt_punish_if_backdoor_fails(adaptation_steps, circular_dual_dl, learner, criterion, shots, ways, device, args.arch)
